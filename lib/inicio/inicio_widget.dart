                          ...
                          children: [
                            StreamBuilder<List<TurnosRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<TurnosRecord> columnTurnosRecordList =
                                    snapshot.data!;
                                return Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: List.generate(
                                      columnTurnosRecordList.length,
                                      (columnIndex) {
                                    final columnTurnosRecord =
                                        columnTurnosRecordList[columnIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          12.0, 10.0, 12.0, 0.0),
                                      child: Material(
